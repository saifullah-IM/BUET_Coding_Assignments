...
def make_plot(y_key, dicts):
    ...
    plt.tight_layout()
    plt.savefig('number_of_nodes_vs_' + y_key + '.png')
    plt.clf()


def report():
    dicts = [readfile("trace_nodes_20.tr"), readfile("trace_nodes_40.tr"), readfile("trace_nodes_60.tr"),
             readfile("trace_nodes_80.tr"), readfile("trace_nodes_100.tr")]
