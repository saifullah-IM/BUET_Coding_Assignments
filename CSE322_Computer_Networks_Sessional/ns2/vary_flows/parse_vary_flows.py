...
def make_plot(y_key, dicts):
    ...
    plt.tight_layout()
    plt.savefig('number_of_flows_vs_' + y_key + '.png')
    plt.clf()


def report():
    dicts = [readfile("trace_flows_10.tr"), readfile("trace_flows_20.tr"), readfile("trace_flows_30.tr"),
             readfile("trace_flows_40.tr"), readfile("trace_flows_50.tr")]
